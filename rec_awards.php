...
if(isset($_GET['title']))
{
    ...
    $stmt = $conn->prepare("INSERT INTO awards (id, title, issuing_agency, issuing_date) VALUES (?,?,?,?)");
                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="x_panel">
                                    ...
                                    <?php
                                    $sql = "SELECT i, id, title, issuing_agency, issuing_date FROM awards WHERE id=".$_SESSION['id'];
...
<form>
            ...
            <div class="form-group">
                <label for="id_title">Award Title</label>
    ...
    <div class="form-group">
            <button type="submit" class="btn btn-primary">Submit</button>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<a class="btn btn-danger" href="rec_clear.php?table=awards">Clear</a>
    </div>
</form>                                        </div>
