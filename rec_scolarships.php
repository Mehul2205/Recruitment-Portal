...
if (isset($_GET['title']))
{
    ...
    $stmt = $conn->prepare("INSERT INTO scholarships (id, title, issuing_agency, issuing_date) VALUES (?,?,?,?)");
                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="x_panel">
                                    ...
                                    <?php
                                    $sql = "SELECT i, id, title, issuing_agency, issuing_date FROM scholarships WHERE id=".$_SESSION['id'];
...
<form>
            <div class="form-group">
                <labelfor="id_title">Scholarship Name</label>
    ...
    <div class="form-group">
            <button type="submit" class="btn btn-primary">Submit</button>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<a class="btn btn-danger" href="rec_clear.php?table=scholarships">Clear</a>
    </div>
</form>                                        </div>
