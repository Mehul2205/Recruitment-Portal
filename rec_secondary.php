...
if(isset($_GET['degree']))
{
    ...
    $sql="DELETE FROM `secondary` WHERE id='".$_SESSION['id']."';";
    $conn->query($sql);

    $stmt = $conn->prepare("INSERT INTO `secondary` (`id`, `degree`, `discipline`, `institute`, `university`, `year_passed`, `date_of_result`, `marks`) VALUES (?,?,?,?,?,?,?,?)");
    $stmt->bind_param("ssssssss", $_SESSION['id'], $degree, $discipline, $institute, $university, $year_passed, $date_of_result, $marks);
    $stmt->execute();
}

$sql1 = "SELECT degree,discipline,institute,university,year_passed,date_of_result,marks FROM `secondary` WHERE id='".$_SESSION['id']."';";
                                            ...
                                            <form method="get" action="">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="id_university" name="university" tabindex="-1" aria-hidden="true" value="<?php echo htmlspecialchars($university1); ?>">
                                                        ...
                                                        <option value="BEM">Board of Education Manipur</option>
                                                        <option value="BHSIEUP">Board of High School and Intermediate Education Uttar Pradesh</option>
                                                        <option value="BSEAP">Board of Secondary Education Andhra Pradesh</option>
                                                        <option value="BSEA">Board of Secondary Education Assam</option>
                                                        <option value="BSEMP">Board of Secondary Education Madhya Pradesh</option>
                                                        <option value="BSEO">Board of Secondary Education Orissa</option>
                                                        ...
                                                        <option value="KBPE">Kerala Board of Public Examination</option>
                                                        <option value="MPSOSB">Madhya Pradesh State Open School Board</option>
                                                        ...
                                                        <option value="NIOS">National Institute of Open Schooling</option>
                                                        <option value="PSEB">Punjab School Education Board</option>
                                                        <option value="RMV">Ravindra Mukta Vidyalaya</option>
                                                        <option value="TNSBSE">Tamil Nadu State Board of School Examinations</option>
                                                        <option value="TEBSE">Telangana Board of Secondary Education</option>
                                                        ...
                                                        <option value="WBBME">West Bengal Board of Madrasah Education</option>
                                                        ...
                                                        <option value="RGDE">Riyadh General Directorate of Examinations</option>
                                                    </select>
                                                </div>
