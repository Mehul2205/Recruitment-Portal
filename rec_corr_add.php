...
if(isset($_GET['address_line1']))
{
    ...
    $sql="DELETE FROM `caddress` WHERE id='".$_SESSION['id']."';";
    $conn->query($sql);

    $stmt = $conn->prepare("INSERT INTO `caddress` (`id`, `address_line1`, `address_line2`, `city`, `pincode`, `district`, `state`,`specialization1`,`specialization2`,`specialization3`) VALUES (?,?,?,?,?,?,?,?,?,?)");
    $stmt->bind_param("ssssssssss", $_SESSION['id'],$address_line1, $address_line2, $city, $pincode, $district, $state,$specialization1, $specialization2, $specialization3);
    $stmt->execute();
}
$sql1 = "SELECT address_line1, address_line2, city, pincode, district, state, specialization1, specialization2, specialization3 FROM `caddress` WHERE id='".$_SESSION['id']."';";
                                        ...
                                        <div class="jumbotron">
                                            <form method="get" action="">    
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="district" name="district" tabindex="-1" aria-hidden="true">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="id_state" name="state" tabindex="-1" aria-hidden="true">
