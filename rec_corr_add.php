...
if(isset($_GET['address_line1']))
{
    ...
    $stmt = $conn->prepare("INSERT INTO `caddress` (`id`, `address_line1`, `address_line2`, `city`, `pincode`, `district`, `state`) VALUES (?,?,?,?,?,?,?)");
    $stmt->bind_param("sssssss", $_SESSION['id'],$address_line1, $address_line2, $city, $pincode, $district, $state);
    $stmt->execute();
}
                                    ...
                                    <div class="x_content">
                                        ...
                                        <div class="jumbotron">
                                            <form method="get" action="">    
                                                ...
                                                <div class="form-group">
                                                    <label for="id_state">Is Correspondence address is same as permanent address</label><br>
                                                    <input type="radio" name="addr" value="yes" checked> Yes<br>
                                                    <input type="radio" name="addr" value="no"> No<br>
                                                </div>                                                
