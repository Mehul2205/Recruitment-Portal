...
if(isset($_GET['name']))
{
    ...
    $stmt = $conn->prepare("INSERT INTO stcourses (id, name, short_description, start_date,end_date) VALUES (?,?,?,?,?)");
                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="x_panel">
                                    ...
                                    <?php
                                    $sql = "SELECT i, id, name, short_description, start_date, end_date FROM stcourses WHERE id=".$_SESSION['id'];
...
<form method="get">
            ...
            <div class="form-group">
                <label for="id_name">Name of the course<span class="required">*</span></label>
    ...
    <div class="form-group">
            <button type="submit" class="btn btn-primary">Submit</button>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<a class="btn btn-danger" href="rec_clear.php?table=stcourses">Clear</a>
    </div>
</form>                                        </div>
